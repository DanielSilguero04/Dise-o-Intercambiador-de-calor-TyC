...
def main(page: ft.Page):
    ...
    def cambiar_interfaz_2(e):
        ...
        Lista_Sustancias_1 = ["Agua", "Tetracloruro de Carbono"]
        Lista_Sustancias_2 = ["Agua", "Tetracloruro de Carbono"]
    ...
    def cambiar_interfaz_3(e):
        ...
        nonlocal Flujo_másico_Caliente,Temp_Entrada_Caliente,Temp_Salida_Caliente,Temp_Entrada_Frio,Temp_Salida_Frio
        ...
        def actualizar_boton_iniciar():
            ...
            if (Flujo_másico_Caliente.value and Temp_Entrada_Caliente.value and Temp_Salida_Caliente.value
                ...
                if IniciarCodigo_Botón is None:
                    IniciarCodigo_Botón = ft.ElevatedButton(text="Iniciar", on_click=lambda e: iniciar_calculos())
    ...
    def cambiar_interfaz_4():
        ...
        #-------------------------------------------------------------------------------------------------------------------------------------------------    
            ...
            RangoInferiorDps= 0.07
            RangoSuperiorDps= 10
            RangoInferiorDptotal= 0.01
            RangoSuperiorDptotal= 10

            Contador += 1

                    # Mostrar los resultados

            if RangoInferiorDps <= Dp_s <= RangoSuperiorDps and RangoInferiorDptotal <= Dp_total <= RangoSuperiorDptotal :     
