...
def main(page: ft.Page):
    ...
    def cambiar_interfaz_2(e):
        ...
        Lista_Sustancias_1 = ["Agua", "Tetracloruro de Carbono","Kerosene","Acido acético 5%","Etilenglicol"]
        Lista_Sustancias_2 = ["Agua", "Tetracloruro de Carbono","Kerosene","Acido acético 5%","Etilenglicol"]
