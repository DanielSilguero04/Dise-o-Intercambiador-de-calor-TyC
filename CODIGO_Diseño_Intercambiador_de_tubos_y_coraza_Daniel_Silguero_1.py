...
def main(page: ft.Page):
    ...
    def cambiar_interfaz_4():
        ...
        #-------------------------------------------------------------------------------------------------------------------------------------------------    
            ...
            Dp_s= (((f_s)*(Gs**2)*(Dis/12)*(N_1))/(2*(4.18*10**(8))*(Dens_F)*(Deq/12)))*(1/144)
            ...
            if RangoInferiorDps <= Dp_s <= RangoSuperiorDps and RangoInferiorDptotal <= Dp_total <= RangoSuperiorDptotal and Efectividad > ValorMinimoEfectividad:     
                resultados_column.append(
                    ft.Column([
                        ...
                        ft.Text(f"Caida de presión en la tubería: {Dp_total: .7f}",text_align=ft.TextAlign.CENTER),
                        ft.Text(f"Caida de presión en la coraza: {Dp_s: .7f}",text_align=ft.TextAlign.CENTER),
